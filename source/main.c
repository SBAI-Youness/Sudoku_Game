...
int main() {
  ...
  Texture2D game_icon_texture =
                LoadResizedTexture("../assets/icons/game_icon.png",
                                   WINDOW_WIDTH / 8, WINDOW_HEIGHT / 8),
            required_image_texture =
                LoadResizedTexture("../assets/images/required.png", 28, 28),
            back_image_texture =
                LoadResizedTexture("../assets/images/back.png", 28, 28),
            pause_image_texture =
                LoadResizedTexture("../assets/images/pause.png", 28, 28);
  ...
  while (WindowShouldClose() == false) {
    ...
    case MODE_MENU:
      HandleDifficultyProcess(&game_state, &game_difficulty, game_icon_texture,
                              back_image_texture);
      break;
    ...
    case PLAYING:
      HandlePlayingProcess(player, &game_state, &game_difficulty,
                           pause_image_texture);
      break;
    ...
    case LOADING:
      ...
      DrawSpinner((Vector2){WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2}, 18.0f, 28,
                  7.0f, SKYBLUE, spinnerTime);
