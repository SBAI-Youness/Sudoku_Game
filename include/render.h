...
extern void RenderPlayingPage(struct Player *player, enum GAME_DIFFICULTY game_difficulty, Texture2D pause_image_texture, struct Cell grid[GRID_SIZE][GRID_SIZE], int selected_row, int selected_column, bool last_move_correct);
